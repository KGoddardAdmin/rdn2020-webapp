<%@ Page Language="VB" Debug="true" AutoEventWireup="false" Inherits="CProcessPage" Codebehind="CProcessPage.aspx.vb" %>
...
<body>
    ...
    <div>
        <uc1:CheckJS ID="CheckJS1" runat="server"  NonJSTargetURL="~/NonJavaScriptProcess.aspx?" />
        <table>  
             <tr>
                <td>            
