<%@ Page Language="VB" Debug="true" ValidateRequest="false"  MasterPageFile="Admin.master" AutoEventWireup="false" Inherits="CampaignCreateCreative" title="Untitled Page" Codebehind="CampaignCreate.aspx.vb" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mstMain" Runat="Server">
	...
	<tr>
		<td colspan="2" style="height: 47px">
			...
			<asp:RequiredFieldValidator ID="rfvDescription" runat="server" ControlToValidate="txtEDescription"
				ErrorMessage="Ad Description is required." Display="None" ValidationGroup="frmCampaign"></asp:RequiredFieldValidator>
