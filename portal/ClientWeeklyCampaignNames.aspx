<%@ Page Title="" Language="VB" MasterPageFile="~/portal/Admin.master" AutoEventWireup="false" CodeFile="ClientWeeklyCampaignNames.aspx.vb" Inherits="portal_ClientWeeklyCampaignNames" %>
    ...
    <div id="ContentHeader">
        <table width="100%" cellpadding="0" cellspacing="0" class="toolbar">
            ...
            <tr>
                <td style="text-align: left; padding-left: 10px; font-weight:bold;">
                     Date: 
                     <asp:DropDownList ID="ddlGetTimeSpan" runat="server">
                     </asp:DropDownList>
                     <br /><br />
